    ...
    <div>
      {loading ? (
        ...
        <div className="w-full p-4 flex flex-col ">
          <button className="w-44 my-4 m-0 " onClick={() => navigate('/tasks')}> ◀️Back to board</button>
          <div className="flex flex-col w-full p-4 border-solid border-2 border-neutral-500 rounded-md">
            {isEditing ? (
              <>
                  <strong>Title:</strong>{" "}
                  <input
